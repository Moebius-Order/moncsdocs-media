...
## 🗂️ Folder Architecture & Path Structure
...
**⚠️ Pull Requests modifying this directory will be automatically rejected.**
...
This is where **ALL community contributions must be placed**. The `/data` directory contains:
...
### Path Logic: Repository → CDN Mapping
...
By uploading an asset to the `/data` directory, you grant **Moebius Order** the following rights:

1. **CDN Distribution**: Right to serve your asset via `media.moncsdocs.moebiusorder.com`
2. **Format Conversion**: Right to optimize or convert formats for performance (e.g., PNG → WebP)
...
All of the above is subject to the **CC BY-SA 4.0 license** terms, meaning:
...
**Response Time**: Moebius Order will respond within **48-72 hours** and will:
...
**Sponsor Button**: Click ❤️ **Sponsor** at the top of this repository
...
- ⬆️ Increase CDN bandwidth capacity
...
**Under these terms**:
- 🏷️ **Attribution** — Credit "MonCSDocs Media by Moebius Order and contributors"
